...
def bdev_lvol_unload_lvstore(client, uuid=None, lvs_name=None):
    """Unload a logical volume store.

    Args:
        uuid: UUID of logical volume store to unload (optional)
        lvs_name: name of logical volume store to unload (optional)
