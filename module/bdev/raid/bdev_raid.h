...
int raid_bdev_stop_base_bdev_delta_bitmap(char *base_bdev_name, raid_bdev_action_cb cb_fn,
		void *cb_arg);
int raid_bdev_clear_base_bdev_faulty_state(char *base_bdev_name, raid_bdev_action_cb cb_fn,
		void *cb_arg);
