		  ...
		  bool delta_bitmap_enabled, struct raid_bdev **raid_bdev_out)
{
	...
	if (level != SPDK_BDEV_RAID_LEVEL_RAID1 && delta_bitmap_enabled) {
...
raid_bdev_create(const char *name, uint32_t strip_size, uint8_t num_base_bdevs,
		 ...
		 const struct spdk_uuid *uuid, bool delta_bitmap_enabled,
		 raid_bdev_action_cb cb_fn, void *cb_ctx)
{
...
static int
_raid_bdev_base_bdev_clear_faulty_state(void *arg, raid_bdev_action_cb cb_fn, void *cb_arg)
{
 ...
 */
int
raid_bdev_stop_base_bdev_delta_bitmap(char *base_bdev_name, raid_bdev_action_cb cb_fn,
				      void *cb_arg)
{
	struct raid_bdev_delta_bitmap_ctx *ctx;
	struct raid_base_bdev_info *base_info;
 ...
 */
int
raid_bdev_clear_base_bdev_faulty_state(char *base_bdev_name, raid_bdev_action_cb cb_fn,
				       void *cb_arg)
{
	struct raid_base_bdev_info *base_info;
	int rc;
...
{
	struct raid_bdev_delta_bitmap_ctx *ctx;
	raid_bdev_action_cb cb_fn = NULL;
	void *cb_ctx = NULL;
	int rc;
