...
static const struct spdk_json_object_decoder rpc_bdev_lvol_unload_lvstore_decoders[] = {
	{"uuid", offsetof(struct rpc_bdev_lvol_unload_lvstore, uuid), spdk_json_decode_string, true},
	{"lvs_name", offsetof(struct rpc_bdev_lvol_unload_lvstore, lvs_name), spdk_json_decode_string, true},
};

static void
rpc_lvol_store_unload_cb(void *cb_arg, int lvserrno)
{
	struct spdk_jsonrpc_request *request = cb_arg;
			     ...
			     const struct spdk_json_val *params)
{
	...
	vbdev_lvs_unload(lvs, rpc_lvol_store_unload_cb, request);
...
static const struct spdk_json_object_decoder rpc_bdev_lvol_load_lvstore_decoders[] = {
	{"uuid", offsetof(struct rpc_bdev_lvol_load_lvstore, uuid), spdk_json_decode_string, true},
	{"lvs_name", offsetof(struct rpc_bdev_lvol_load_lvstore, lvs_name), spdk_json_decode_string, true},
};

static void
rpc_lvol_store_load_cb(void *cb_arg, int lvserrno)
{
	struct spdk_jsonrpc_request *request = cb_arg;
			     ...
			     const struct spdk_json_val *params)
{
	...
	vbdev_lvs_load(lvs, rpc_lvol_store_load_cb, request);
