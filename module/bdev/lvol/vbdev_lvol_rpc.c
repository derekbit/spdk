...
static void
free_rpc_bdev_lvol_snapshot_req(struct rpc_bdev_lvol_snapshot *req)
{
	free(req->lvol_name);
...
cleanup:
	free_rpc_bdev_lvol_snapshot_req(&req);
}
...
static const struct spdk_json_object_decoder rpc_bdev_lvol_set_xattr_decoders[] = {
	{"name", offsetof(struct rpc_bdev_lvol_set_xattr_ctx, name), spdk_json_decode_string},
	{"xattr_name", offsetof(struct rpc_bdev_lvol_set_xattr_ctx, xattr_name), spdk_json_decode_string},
	{"xattr_value", offsetof(struct rpc_bdev_lvol_set_xattr_ctx, xattr_value), spdk_json_decode_string},
};
...
rpc_bdev_lvol_set_xattr(struct spdk_jsonrpc_request *request,
			const struct spdk_json_val *params)
{
	struct rpc_bdev_lvol_set_xattr_ctx req = {};
	struct spdk_bdev *bdev;
	struct spdk_lvol *lvol;
...
static const struct spdk_json_object_decoder rpc_bdev_lvol_get_xattr_decoders[] = {
	{"name", offsetof(struct rpc_bdev_lvol_get_xattr_ctx, name), spdk_json_decode_string},
	{"xattr_name", offsetof(struct rpc_bdev_lvol_get_xattr_ctx, xattr_name), spdk_json_decode_string},
};
...
rpc_bdev_lvol_get_xattr(struct spdk_jsonrpc_request *request,
			const struct spdk_json_val *params)
{
	struct rpc_bdev_lvol_get_xattr_ctx req = {};
	struct spdk_json_write_ctx *w;
	struct spdk_bdev *bdev;
	struct spdk_lvol *lvol;
...
static const struct spdk_json_object_decoder rpc_bdev_lvol_start_range_shallow_copy_decoders[] = {
	{"src_lvol_name", offsetof(struct rpc_bdev_lvol_start_range_shallow_copy_ctx, src_lvol_name), spdk_json_decode_string},
	{"dst_bdev_name", offsetof(struct rpc_bdev_lvol_start_range_shallow_copy_ctx, dst_bdev_name), spdk_json_decode_string},
	{"clusters", offsetof(struct rpc_bdev_lvol_start_range_shallow_copy_ctx, clusters), rpc_decode_cluster_indexes, true},
};
...
rpc_bdev_lvol_start_range_shallow_copy(struct spdk_jsonrpc_request *request,
				       const struct spdk_json_val *params)
{
	struct rpc_bdev_lvol_start_range_shallow_copy_ctx req = {};
	struct rpc_bdev_lvol_shallow_copy_ctx *ctx;
	struct spdk_lvol *src_lvol;
	struct spdk_bdev *src_lvol_bdev;
	struct rpc_shallow_copy_status *status;
	...
	status->operation_id = ++g_shallow_copy_count;
	status->total_clusters = req.clusters.count;
	...
	ctx->request = request;
	ctx->status = status;
	ctx->clusters = calloc(req.clusters.count, sizeof(uint64_t));
	...
	memcpy(ctx->clusters, req.clusters.items, req.clusters.count * sizeof(uint64_t));

	LIST_INSERT_HEAD(&g_shallow_copy_status_list, status, link);
	rc = vbdev_lvol_range_shallow_copy(src_lvol, req.dst_bdev_name,
					   ctx->clusters, req.clusters.count,
					   rpc_bdev_lvol_shallow_copy_status_cb, status,
					   rpc_bdev_lvol_shallow_copy_cb, ctx);
...
cleanup:
	free_rpc_bdev_lvol_start_range_shallow_copy(&req);
}
...
static const struct spdk_json_object_decoder rpc_bdev_lvol_start_deep_copy_decoders[] = {
	{"src_lvol_name", offsetof(struct rpc_bdev_lvol_start_deep_copy_ctx, src_lvol_name), spdk_json_decode_string},
	{"dst_bdev_name", offsetof(struct rpc_bdev_lvol_start_deep_copy_ctx, dst_bdev_name), spdk_json_decode_string},
};
...
rpc_bdev_lvol_start_deep_copy(struct spdk_jsonrpc_request *request,
			      const struct spdk_json_val *params)
{
	struct rpc_bdev_lvol_start_deep_copy_ctx req = {};
...
cleanup:
	free_rpc_bdev_lvol_start_deep_copy(&req);
}
...
static const struct spdk_json_object_decoder rpc_bdev_lvol_check_deep_copy_decoders[] = {
	{"operation_id", offsetof(struct rpc_bdev_lvol_check_deep_copy_ctx, operation_id), spdk_json_decode_uint32},
};
...
rpc_bdev_lvol_check_deep_copy(struct spdk_jsonrpc_request *request,
			      const struct spdk_json_val *params)
{
	struct rpc_bdev_lvol_check_deep_copy_ctx req = {};
	struct rpc_deep_copy_status *status;
	struct spdk_json_write_ctx *w;
...
cleanup:
	free_rpc_bdev_lvol_check_deep_copy(&req);
}
...
static const struct spdk_json_object_decoder rpc_bdev_lvol_get_fragmap_decoders[] = {
	{"name", offsetof(struct rpc_bdev_lvol_get_fragmap_ctx, name), spdk_json_decode_string},
	{"offset", offsetof(struct rpc_bdev_lvol_get_fragmap_ctx, offset), spdk_json_decode_uint64, true},
	{"size", offsetof(struct rpc_bdev_lvol_get_fragmap_ctx, size), spdk_json_decode_uint64, true},
};
...
{
	struct rpc_bdev_lvol_get_fragmap_ctx req = {};
	struct spdk_bdev *bdev;
	struct spdk_lvol *lvol;
...
static const struct spdk_json_object_decoder rpc_bdev_snapshot_range_checksum_decoders[] = {
	{"name", offsetof(struct rpc_bdev_snapshot_checksum, name), spdk_json_decode_string},
		...
		const struct spdk_json_val *params)
{
	...
	if (spdk_json_decode_object(params, rpc_bdev_snapshot_range_checksum_decoders,
				    SPDK_COUNTOF(rpc_bdev_snapshot_range_checksum_decoders),
				    &req)) {
		SPDK_INFOLOG(lvol_rpc, "spdk_json_decode_object failed\n");
		spdk_jsonrpc_send_error_response(request, SPDK_JSONRPC_ERROR_INTERNAL_ERROR,
						 "spdk_json_decode_object failed");
