...
### bdev_lvol_start_range_shallow_copy {#rpc_bdev_lvol_start_range_shallow_copy}

Start a ranged shallow copy of an lvol over a given bdev. Data of clusters allocated to the lvol
will be written on the bdev, data of clusters not allocated to the lvol will be unmapped on the bdev.
Must have:

* lvol read only
* lvol size less or equal than bdev size
* lvstore block size an even multiple of bdev block size
* clusters must fit into lvol cluster range
...
src_lvol_name           | Required | string      | UUID or alias of lvol to create a copy from
dst_bdev_name           | Required | string      | Name of the bdev that acts as destination for the copy
clusters                | Required | array       | Array of indexes of the clusters to be synchronized
...
{
  "jsonrpc": "2.0",
  "method": "bdev_lvol_start_range_shallow_copy",
  "id": 1,
  "params": {
    "src_lvol_name": "8a47421a-20cf-444f-845c-d97ad0b0bd8e",
    "dst_bdev_name": "Nvme1n1",
...
### bdev_lvol_stop_snapshot_checksum {#rpc_bdev_lvol_stop_snapshot_checksum}

Stop an ongoing registration of a snapshot's checksum.
...
{
  "jsonrpc": "2.0",
  "method": "bdev_lvol_stop_snapshot_checksum",
  "id": 1,
  "params": {
    "name": "8d87fccc-c278-49f0-9d4c-6237951aca09"
  }
...
### bdev_lvol_register_snapshot_range_checksums {#rpc_bdev_lvol_register_snapshot_range_checksums}

Compute and store snapshot's whole and clusters checksums. A checksum for the whole lvol and a checksum for every
allocated cluster is computed and stored in snapshot's metadata. The computed checksum is crc64 iso reflected.
...
{
  "jsonrpc": "2.0",
  "method": "bdev_lvol_register_snapshot_range_checksums",
  "id": 1,
  "params": {
    "name": "8d87fccc-c278-49f0-9d4c-6237951aca09"
  }
...
### bdev_lvol_get_snapshot_range_checksums {#rpc_bdev_lvol_get_snapshot_range_checksums}

Get snapshot's clusters checksums in a specific range. The lvol must be a snapshot and the
checksums must have been previously registered. The range must fit into snapshot's cluster number
...
----------------------- | -------- | ----------- | -----------
name                    | Required | string      | UUID or alias of the snapshot
cluster_start_index     | Required | number      | start index of the cluster range
cluster_count           | Required | number      | number of clusters in the range
...
{
  "jsonrpc": "2.0",
  "method": "bdev_lvol_get_snapshot_range_checksums",
  "id": 1,
  "params": {
    "name": "8d87fccc-c278-49f0-9d4c-6237951aca09",
